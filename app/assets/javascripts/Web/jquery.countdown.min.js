  ...
  e.JQPlugin.createPlugin({
    ...
    _init: function() {
      ...
      var s = "function" == typeof Date.now ? Date.now : function() {
        ...
        o = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame ||
        window.msRequestAnimationFrame || null,
        a = 0;
      !o || e.noRequestAnimationFrame ? (e.noRequestAnimationFrame = null, setInterval(function() {
        i._updateElems()
      }, 980)) : (a = window.animationStartTime || window.webkitAnimationStartTime || window.mozAnimationStartTime || window.oAnimationStartTime ||
        window.msAnimationStartTime || s(), o(t))
    },
    UTCDate: function(e, t, i, s, n, o, a, r) {
      "object" == typeof t && t.constructor == Date && (r = t.getMilliseconds(), a = t.getSeconds(), o = t.getMinutes(), n = t.getHours(), s = t.getDate(),
        i = t.getMonth(), t = t.getFullYear());
      var l = new Date;
      return l.setUTCFullYear(t), l.setUTCDate(1), l.setUTCMonth(i || 0), l.setUTCDate(s || 1), l.setUTCHours(n || 0), l.setUTCMinutes((o || 0) - (Math.abs(
        e) < 30 ? 60 * e : e)), l.setUTCSeconds(a || 0), l.setUTCMilliseconds(r || 0), l
    },
    ...
    _adjustSettings: function(t, i, s) {
      ...
      _ = null == _ ? -n.getTimezoneOffset() : _, (s || !s && null == i._until && null == i._since) && (i._since = i.options.since, null != i._since && (
            i._since = this.UTCDate(_, this._determineTime(i._since, null)), i._since && o && i._since.setMilliseconds(i._since.getMilliseconds() + o)),
          i._until = this.UTCDate(_, this._determineTime(i.options.until, n)), o && i._until.setMilliseconds(i._until.getMilliseconds() + o)), i._show =
        this._determineShow(i)
    },
    ...
    _hold: function(t, i) {
      ...
      if (s) {
        if ("pause" == s._hold && !i) {
          ...
          var n = s._since ? "-" : "+";
          s[s._since ? "_since" : "_until"] = this._determineTime(n + s._periods[0] + "y" + n + s._periods[1] + "o" + n + s._periods[2] + "w" + n + s._periods[
            3] + "d" + n + s._periods[4] + "h" + n + s._periods[5] + "m" + n + s._periods[6] + "s"), this._addElem(t)
        }
    ...
    _determineTime: function(e, t) {
      var i = this,
        ...
        n = function(e) {
          e = e.toLowerCase();
          for (var t = new Date, s = t.getFullYear(), n = t.getMonth(), o = t.getDate(), a = t.getHours(), r = t.getMinutes(), l = t.getSeconds(), _ =
              /([+-]?[0-9]+)\s*(s|m|h|d|w|o|y)?/g, p = _.exec(e); p;) {
            switch (p[2] || "s") {
              case "s":
                l += parseInt(p[1], 10);
                break;
    ...
    _generateHTML: function(t) {
      ...
      for (var p = !1, u = 0, c = t.options.significant, h = e.extend({}, t._show), d = i; l >= d; d++) p |= "?" == t._show[d] && t._periods[d] > 0, h[d] =
        "?" != t._show[d] || p ? t._show[d] : null, u += h[d] ? 1 : 0, c -= t._periods[d] > 0 ? 1 : 0;
      ...
      var g = t.options.compact ? t.options.compactLabels : t.options.labels,
        ...
        y = function(e) {
          ...
          return !t.options.significant && h[e] || t.options.significant && m[e] ? '<span class="' + _._sectionClass + '"><span class="' + _._amountClass +
            '">' + _._minDigits(t, t._periods[e], D) + '</span><span class="' + _._periodClass + '">' + (i ? i[e] : g[e]) + "</span></span>" : ""
        };
      return t.options.layout ? this._buildLayout(t, h, t.options.layout, t.options.compact, t.options.significant, m) : (t.options.compact ?
        '<span class="' + this._rowClass + " " + this._amountClass + (t._hold ? " " + this._holdingClass : "") + '">' + f(i) + f(s) + f(n) + f(o) + (h[
          a] ? this._minDigits(t, t._periods[a], 2) : "") + (h[r] ? (h[a] ? t.options.timeSeparator : "") + this._minDigits(t, t._periods[r], 2) : "") +
        (h[l] ? (h[a] || h[r] ? t.options.timeSeparator : "") + this._minDigits(t, t._periods[l], 2) : "") : '<span class="' + this._rowClass + " " +
        this._showClass + (t.options.significant || u) + (t._hold ? " " + this._holdingClass : "") + '">' + y(i) + y(s) + y(n) + y(o) + y(a) + y(r) + y(
          l)) + "</span>" + (t.options.description ? '<span class="' + this._rowClass + " " + this._descrClass + '">' + t.options.description +
        "</span>" : "")
    },
    ...
    _determineShow: function(e) {
      var t = e.options.format,
        _ = [];
      return _[i] = t.match("y") ? "?" : t.match("Y") ? "!" : null, _[s] = t.match("o") ? "?" : t.match("O") ? "!" : null, _[n] = t.match("w") ? "?" : t.match(
        "W") ? "!" : null, _[o] = t.match("d") ? "?" : t.match("D") ? "!" : null, _[a] = t.match("h") ? "?" : t.match("H") ? "!" : null, _[r] = t.match(
        "m") ? "?" : t.match("M") ? "!" : null, _[l] = t.match("s") ? "?" : t.match("S") ? "!" : null, _
    },
    _calculatePeriods: function(e, t, _, p) {
      e._now = p, e._now.setMilliseconds(0);
      var u = new Date(e._now.getTime());
      e._since ? p.getTime() < e._since.getTime() ? e._now = p = u : p = e._since : (u.setTime(e._until.getTime()), p.getTime() > e._until.getTime() && (
        e._now = p = u));
      var c = [0, 0, 0, 0, 0, 0, 0];
      if (t[i] || t[s]) {
        var h = this._getDaysInMonth(p.getFullYear(), p.getMonth()),
          ...
          w = Math.max(0, 12 * (u.getFullYear() - p.getFullYear()) + u.getMonth() - p.getMonth() + (u.getDate() < p.getDate() && !m || m && g(u) < g(p) ?
            -1 : 0));
      ...
      if (v(n, 604800), v(o, 86400), v(a, 3600), v(r, 60), v(l, 1), y > 0 && !e._since)
        for (var T = [1, 12, 4.3482, 7, 24, 60, 60], M = l, C = 1, b = l; b >= i; b--) t[b] && (c[M] >= C && (c[M] = 0, y = 1), y > 0 && (c[b] ++, y = 0,
          M = b, C = 1)), C *= T[b];
      if (_)
        for (var b = i; l >= b; b++) _ && c[b] ? _-- : _ || (c[b] = 0);
      return c
    }
  })
}(jQuery);
