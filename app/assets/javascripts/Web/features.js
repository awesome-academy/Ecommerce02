! function() {
  var t = function(t) {
    ...
    F = t(function(t) {
      ...
      t.exports = function(t) {
        var n, e, r;
        return t === undefined ? "Undefined" : null === t ? "Null" : "string" == typeof(e = u(n = Object(t), o)) ? e : i ? m(n) : "Object" == (r = m(n)) &&
          "function" == typeof n.callee ? "Arguments" : r
      }
    }),
    k = t(function(t) {
      t.exports = function(t) {
    ...
    p = t(function(t, n) {
      ...
      n.f = d ? Object.defineProperty : function i(t, n, e) {
    ...
    E = t(function(t) {
      t.exports = d ? function(t, n, e) {
        return p.f(t, n, i(1, e))
      } : function(t, n, e) {
        return t[n] = e, t
      }
    }),
    ...
    L = t(function(t) {
      ...
      B.inspectSource = function(t) {
        ...
        o && (O(e, "name") || E(e, "name", n)), t[n] !== e && (o && (O(e, i) || E(e, i, t[n] ? "" + t[n] : u.join(String(n)))), t === T ? t[n] = e : r ?
          t[n] ? t[n] = e : E(t, n, e) : (delete t[n], E(t, n, e)))
      ...
      t.exports = function(c) {
        return function(t, n) {
          var e, r, o = String(f(t)),
            i = s(n),
            u = o.length;
          return i < 0 || u <= i ? c ? "" : undefined : (e = o.charCodeAt(i)) < 55296 || 56319 < e || i + 1 === u || (r = o.charCodeAt(i + 1)) < 56320 ||
            57343 < r ? c ? o.charAt(i) : e : c ? o.slice(i, i + 2) : r - 56320 + (e - 55296 << 10) + 65536
        }
      }
    }),
    M = t(function(t) {
      ...
      var y = "prototype",
        v = function(t, n, e) {
          var r, o, i, u, c = t & v.F,
            ...
            p = s ? B : B[n] || (B[n] = {}),
            h = p[y] || (p[y] = {});
          for (r in s && (e = n), e) i = ((o = !c && d && d[r] !== undefined) ? d : e)[r], u = l && o ? R(i, T) : a && "function" == typeof i ? R(Function.call,
            i) : i, d && L(d, r, i, t & v.U), p[r] != i && E(p, r, u), a && h[r] != i && (h[r] = i)
        };
    ...
    U = t(function(t) {
      t.exports = d ? Object.defineProperties : function u(t, n) {
        h(t);
        for (var e, r = P(n), o = r.length, i = 0; i < o;) p.f(t, e = r[i++], n[e]);
        return t
      }
    }),
    N = t(function(t) {
      ...
      var r = A("IE_PROTO"),
        ...
        u = function() {
          var t, n = _("iframe"),
            ...
            r = "<",
            o = ">";
          for (n.style.display = "none", N.appendChild(n), n.src = "javascript:", (t = n.contentWindow.document).open(), t.write(r + "script" + o +
              "document.F=Object" + r + "/script" + o), t.close(), u = t.F; e--;) delete u[i][S[e]];
          return u()
        };
    ...
    V = t(function(t) {
      ...
      t.exports = Object.getPrototypeOf || function(t) {
        return t = z(t), O(t, n) ? t[n] : "function" == typeof t.constructor && t instanceof t.constructor ? t.constructor.prototype : t instanceof Object ?
          e : null
      }
    }),
    W = t(function(t) {
      ...
      t.exports = function(t, n, o, e, r, i, u) {
        ...
        if (b && (f = V(b.call(new t))) !== Object.prototype && f.next && (H(f, l, !0), M || O(f, x) || E(f, x, P)), d && y && y.name !== S && (p = !0, v =
            function _() {
              return y.call(this)
            }), M && !u || !w && !p && h[x] || E(h, x, v), D[n] = v, D[l] = P, r)
          if (c = {
              values: d ? v : a(S),
              keys: i ? v : a(A),
              entries: m
    ...
    tt = t(function(t) {
      ...
      t.exports = function(t, n) {
        ...
        return r === undefined || (e = h(r)[o]) == undefined ? n : I(e)
      }
    }),
    nt = t(function(t) {
      t.exports = function(t, n, e) {
    ...
    et = t(function(t) {
      ...
      i && u || (i = function h(t) {
          ...
          delete a[t]
        }, "process" == m(o) ? r = function(t) {
          o.nextTick(R(d, t, 1))
        } : s && s.now ? r = function(t) {
          s.now(R(d, t, 1))
        } : c ? (e = (n = new c).port2, n.port1.onmessage = p, r = R(e.postMessage, e, 1)) : T.addEventListener && "function" == typeof postMessage && !T.importScripts ?
        (r = function(t) {
          T.postMessage(t + "", "*")
        }, T.addEventListener("message", p, !1)) : r = l in _("script") ? function(t) {
          N.appendChild(_("script"))[l] = function() {
            N.removeChild(this), d.call(t)
          }
        } : function(t) {
          setTimeout(R(d, t, 1), 0)
        }), t.exports = {
        set: i,
        clear: u
      }
    ...
    at = (t(function() {
            ...
            i(function() {
              for (var s = a._v, f = 1 == a._s, t = 0, n = function(t) {
                  var n, e, r = f ? t.ok : t.fail,
                    ...
                    u = t.domain;
                  try {
                    r ? (f || (2 == a._h && b(a), a._h = 1), !0 === r ? n = s : (u && u.enter(), n = r(s), u && u.exit()), n === t.promise ? i(l(
                      "Promise-chain cycle")) : (e = h(n)) ? e.call(n, o, i) : o(n)) : i(s)
                  } catch (c) {
                    i(c)
                  }
                }; r.length > t;) n(r[t++]);
      ...
      p || (s = function w(t) {
        ...
        then: function A(t, n) {
          var e = d(tt(this, s));
          return e.ok = "function" != typeof t || t, e.fail = "function" == typeof n && n, e.domain = f ? c.domain : undefined, this._c.push(e),
            this._a && this._a.push(e), this._s && y(this, !1), e.promise
        },
        "catch": function(t) {
        ...
        Promise: s
      }), H(s, u), st(u), o = B[u], C(C.S + C.F * !p, u, {
        reject: function S(t) {
          var n = d(this);
    ...
    lt = (t(function() {
      ...
      "use strict";
      t.exports = function(t, n, e) {
        n in t ? p.f(t, n, i(0, e)) : t[n] = e
      }
    })),
    dt = (t(function() {
      "use strict";
      C(C.S + C.F * !ft(function(t) {
        Array.from(t)
      }), "Array", {
        from: function h(t, n, e) {
          var r, o, i, u, c = z(t),
            ...
            d = 0,
            p = Q(c);
          if (l && (a = R(a, 2 < f ? e : undefined, 2)), p == undefined || s == Array && $(p))
    ...
    pt = (t(function() {
      ...
      C(C.P + C.F * b(function() {
        ...
        slice: function a(t, n) {
          ...
          for (var o = y(t, e), i = y(n, e), u = w(i - o), c = Array(u), s = 0; s < u; s++) c[s] = "String" == r ? this.charAt(o + s) : this[o + s];
          return c
        }
      })
    }), t(function() {
      ...
      t.exports = function(t) {
        var n;
        return at(t) && ("function" != typeof(n = t.constructor) || n !== Array && !at(n.prototype) || (n = undefined), k(n) && null === (n = n[e]) && (n =
          undefined)), n === undefined ? Array : n
      }
    })),
    ht = t(function(t) {
      t.exports = function(t, n) {
    ...
    yt = t(function(t) {
      t.exports = function(l, t) {
        var d = 1 == l,
          ...
          b = t || ht;
        return function(t, n, e) {
          for (var r, o, i = z(t), u = x(i), c = R(n, e, 3), s = w(u.length), f = 0, a = d ? b(t, s) : p ? b(t, 0) : undefined; f < s; f++)
    ...
    mt = (t(function() {
      ...
      "use strict";
      C(C.P + C.F * !dt([].reduceRight, !0), "Array", {
      ...
      t.exports = [].copyWithin || function a(t, n, e) {
        var r = z(this),
          ...
          s = Math.min((c === undefined ? o : y(c, o)) - u, o - i),
          f = 1;
    ...
    bt = (t(function() {
      ...
      t.exports = function f(t, n, e) {
        for (var r = z(this), o = w(r.length), i = arguments.length, u = y(1 < i ? n : undefined, o), c = 2 < i ? e : undefined, s = c === undefined ? o :
            y(c, o); u < s;) r[u++] = t;
        return r
      }
    })),
    ...
    Et = t(function(t) {
      ...
      t.exports = function(r, t, n, e, o, u) {
        ...
        if ("function" == typeof c && (u || f.forEach && !b(function() {
            (new c).entries().next()
          }))) {
          var d = new c,
            p = d[s](u ? {} : -0, 1) != d,
        ...
        return H(c, r), a[r] = c, C(C.G + C.W + C.F * (c != i), a), u || e.setStrong(c, r, o), c
      }
    });
  t(function(t) {
    "use strict";
  ...
  ! function(t) {
    ...
    function l() {
      return this.bodyUsed = !1, this._initBody = function(t) {
        ...
        this.headers.get("content-type") || ("string" == typeof t ? this.headers.set("content-type", "text/plain;charset=UTF-8") : this._bodyBlob && this._bodyBlob
          .type ? this.headers.set("content-type", this._bodyBlob.type) : m.searchParams && URLSearchParams.prototype.isPrototypeOf(t) && this.headers.set(
    ...
    function p(t, n) {
      ...
      if (t instanceof p) {
        ...
        this.url = t.url, this.credentials = t.credentials, n.headers || (this.headers = new u(t.headers)), this.method = t.method, this.mode = t.mode, e ||
          null == t._bodyInit || (e = t._bodyInit, t.bodyUsed = !0)
      } else this.url = String(t);
      if (this.credentials = n.credentials || this.credentials || "omit", !n.headers && this.headers || (this.headers = new u(n.headers)), this.method = d(n.method ||
          this.method || "GET"), this.mode = n.mode || this.mode || null, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && e) throw new TypeError(
    ...
    function v(t, n) {
      n || (n = {}), this.type = "default", this.status = "status" in n ? n.status : 200, this.ok = 200 <= this.status && this.status < 300, this.statusText =
        "statusText" in n ? n.statusText : "OK", this.headers = new u(n.headers), this.url = n.url || "", this._initBody(t)
    }
    if (!t.fetch) {
      var m = {
      ...
      if (m.arrayBuffer) var b = ["[object Int8Array]", "[object Uint8Array]", "[object Uint8ClampedArray]", "[object Int16Array]", "[object Uint16Array]",
      ...
      v.redirect = function(t, n) {
        ...
        return new Promise(function(e, t) {
          ...
          r.onload = function() {
            ...
            t(new TypeError("Network request failed"))
          }, r.open(n.method, n.url, !0), "include" === n.credentials && (r.withCredentials = !0), "responseType" in r && m.blob && (r.responseType =
            "blob"), n.headers.forEach(function(t, n) {
  ...
  var Ot = t(function(t, n) {
    ...
    jt = t(function(t, n) {
      ...
      function e(o) {
        return new Promise(function(e) {
          ...
          r ? (window.Shopify.CartType = "cart_page", e()) : new MutationObserver(function(t, n) {
            (r = document.getElementById(o)) && (window.Shopify.CartType = "cart_ajax", e(), n.disconnect())
      ...
      function r(t, n) {
        return a() ? i(t, n) : u(t, n), e("dynamic-checkout-cart").then(function() {
          o(t, n)
        })
      }
      ...
      function o(t, n) {
        ...
        return r.src = n.dynamic_checkout_cart_url, e.head.appendChild(r), r
      }
      ...
      function i(t, n) {
        ...
        (0, p["default"])(t, e);
        var r = c(t, n);
        return s("[SPB] Script appended"), r
      }
      ...
      function l() {
        ...
        if (null === document.querySelector(t)) {
          ...
          n.id = "shopify-dynamic-checkout", n.innerHTML = y, document.head.appendChild(n)
        }
      }
      Object.defineProperty(n, "__esModule", {
        value: !0
      ...
      var d = v(Ot),
        p = v(Tt),
        h = "undefined" != typeof performance && "function" == typeof performance.mark,
        y =
  ...
  t(function() {
    "use strict";
    (0, v(Ft)["default"])(document.documentElement)
  })
